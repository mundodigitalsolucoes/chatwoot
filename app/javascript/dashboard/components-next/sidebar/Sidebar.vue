...
const showCaptainMenu = computed(
  () => !mdsWhiteLabelFeatures()[MDS_WHITE_LABEL_FEATURES.HIDE_CAPTAIN_MENU]
);

const showHelpCenterMenu = computed(
...
const showSettingsMenu = computed(
  () => !mdsWhiteLabelFeatures()[MDS_WHITE_LABEL_FEATURES.HIDE_SETTINGS_MENU]
);

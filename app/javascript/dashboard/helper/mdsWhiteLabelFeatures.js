...
export const MDS_WHITE_LABEL_FEATURES = Object.freeze({
  ...
  HIDE_UPDATE_BANNER: 'hideUpdateBanner',
  HIDE_CHATWOOT_METADATA: 'hideChatwootMetadata',
});
...
const MDS_WHITE_LABEL_FEATURE_CONFIG = Object.freeze({
  ...
  [MDS_WHITE_LABEL_FEATURES.HIDE_UPDATE_BANNER]: true,
  [MDS_WHITE_LABEL_FEATURES.HIDE_CHATWOOT_METADATA]: true,
});
